# Deck.gl to Dash Plotly

Deck.gl to Dash Plotly is a Dash component library.
...
### Write your component code in `src/lib/components/deckglplotly.react.js`. 
...
- Add custom styles to your component by putting your custom CSS files into your distribution folder (`deckglplotly`).
...
3. Test your tarball by copying it into a new environment and installing it locally:
    ```
    $ pip install deckglplotly-0.0.1.tar.gz
    ```
